...
export function meta() {
    ...
    return [
        ...
        { name: "description", content: "Відповіді на найпоширеніші питання щодо розмірів, доставки, повернення, оплати та догляду за виробами MIND BODY." },
            ...
            <section className="section" style={{ background: '#fff' }}>
                <div className="container" style={{ maxWidth: '820px' }}>
                    ...
                    <div style={{
                        ...
                        <Link to="/contacts" className="btn btn--primary" style={{ display: 'inline-block', padding: '14px 32px' }}>
                            Зв'язатись
                        </Link>
                    </div>
                </div>
