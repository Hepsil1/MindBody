            ...
            <section className="section" style={{ background: "#fff" }}>
                <div className="container" style={{ maxWidth: "820px" }}>
                    <p style={{ marginBottom: "24px" }}>
                        MIND BODY поважає вашу приватність. Ця політика пояснює, які дані ми
                        збираємо, як використовуємо та захищаємо їх відповідно до Закону України
                    ...
                    <ul>
                        <li>
                            Контактні дані: ім'я, прізвище, телефон, email — необхідні для
                            оформлення та доставки замовлення.
                        </li>
                        <li>Адресу доставки: місто, відділення Нової Пошти або Укрпошти.</li>
                        <li>
                            Технічні дані: IP-адреса, тип браузера, час відвідування, cookies — для
                            аналітики та безпеки.
                        </li>
                    ...
                    <ul>
                        ...
                        <li>
                            Маркетингові розсилки — лише за вашою згодою (можна відписатись у
                            будь-який момент).
                        </li>
                    </ul>
                    ...
                    <p>
                        Дані зберігаються на захищених серверах в Україні. Доступ мають лише
                        уповноважені співробітники. Ми використовуємо HTTPS, шифрування паролів
                        (bcrypt) та регулярний аудит безпеки.
                    </p>
                    ...
                    <p>
                        Ми не продаємо ваші дані. Передаємо лише партнерам, необхідним для виконання
                        замовлення: Новій Пошті, Укрпошті, платіжним системам (LiqPay, monobank — за
                        наявності).
                    </p>
                    ...
                    <p>
                        Ми використовуємо технічні cookies (необхідні для роботи сайту) та
                        аналітичні (для розуміння поведінки користувачів). Ви можете керувати
                        cookies через налаштування браузера.
                    </p>
                    ...
                    <p style={{ marginBottom: "40px" }}>
                        ...
                        <a href="mailto:connect@mindbody.com.ua">connect@mindbody.com.ua</a> або
                    ...
                    >
                        <strong>Примітка:</strong> цей документ — базовий шаблон. Перед публічним
                        запуском рекомендуємо перевірити з юристом, що відповідає вашій фактичній
                        обробці даних та реєстрації ФОП.
                    </div>
                </div>
            </section>
        </main>
