...
export function meta() {
    ...
    return [
        ...
        { name: "description", content: "Як правильно прати, сушити та зберігати спортивний одяг MIND BODY, щоб він зберігав форму, колір і технологічні властивості тканини." },
        ...
        <main className="info-page">
            <section className="page-hero" style={{
                ...
                <div className="container">
                    ...
                    <p style={{ marginTop: '12px', color: 'var(--color-text-secondary)', maxWidth: '620px', margin: '12px auto 0' }}>
                ...
                <div className="container" style={{ maxWidth: '980px' }}>
                    ...
                    <div style={{
                        ...
                        {TIPS.map((tip, i) => (
                            ...
                            >
                                <div style={{ fontSize: '36px', marginBottom: '14px' }} aria-hidden="true">{tip.icon}</div>
                                <h3 style={{ marginBottom: '10px', color: 'var(--color-primary)' }}>{tip.title}</h3>
                                <p style={{ color: 'var(--color-text-secondary)', lineHeight: 1.65, fontSize: '15px' }}>
                                    {tip.text}
                                </p>
                            </article>
                        ))}
                    ...
                    <div style={{
                        ...
                        <h2 style={{ color: '#fff', marginBottom: '16px', fontFamily: "'Cormorant Garamond', serif" }}>
                            Чому це важливо
                        </h2>
                        <p style={{ opacity: 0.95, lineHeight: 1.7, fontSize: '16px' }}>
                            Premium Supplex та інші технологічні тканини, з яких ми шиємо, мають
                            мікроскопічну структуру, що дихає й відводить вологу. Правильний догляд зберігає
                            ці властивості на роки. Неправильний — псує їх за кілька прань.
                        </p>
                    </div>

                    <h2 style={{ marginBottom: '20px', color: 'var(--color-primary)' }}>Якщо все ж зіпсували</h2>
                    <p style={{ marginBottom: '24px', color: 'var(--color-text-secondary)', lineHeight: 1.65 }}>
                        Не панікуйте. Напишіть нам — порадимо, що можна зробити. У деяких випадках виріб
                        реально відновити. У будь-якому разі — поверніться до нас за порадою, перш ніж
                        списувати річ.
                    </p>
